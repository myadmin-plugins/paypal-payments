...
class Plugin
{
    ...
    public static function getSettings(GenericEvent $event)
    {
        ...
        $settings->add_password_setting(_('Billing'), _('PayPal'), 'paypal_client_id', _('Client ID'), _('Client ID'), (defined('PAYPAL_CLIENT_ID') ? PAYPAL_CLIENT_ID : ''));
        ...
        $settings->add_password_setting(_('Billing'), _('PayPal'), 'paypal_sandbox_api_password', _('Sandbox API Password'), _('Sandbox API Password'), (defined('PAYPAL_SANDBOX_API_PASSWORD') ? PAYPAL_SANDBOX_API_PASSWORD : ''));
        $settings->add_password_setting(_('Billing'), _('PayPal'), 'paypal_sandbox_api_signature', _('Sandbox API Signature'), _('Sandbox API Signature'), (defined('PAYPAL_SANDBOX_API_SIGNATURE') ? PAYPAL_SANDBOX_API_SIGNATURE : ''));
    }
}
