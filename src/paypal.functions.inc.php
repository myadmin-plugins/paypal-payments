 ...
 * @param string $currency optional currency, defaults to USD
 * @return string the link url
 */
function get_paypal_link_url($custom, $service_cost, $description = '', $currency = 'USD')
{
    if ($description == '') {
        $description = TITLE;
    }
 ...
 * @return string the link url
 */
function get_paypal_subscription_link_url($custom, $service_cost, $description = '', $days_till_first_payment = 1, $frequency = 1)
{
    if ($description == '') {
        $description = TITLE;
    }
 ...
 * @return string the a href link
 */
function get_paypal_link($custom, $service_cost, $description = '', $link_text = 'Click Here to make a PayPal payment', $currency = 'USD')
{
    return '<a href="'.get_paypal_link_url($custom, $service_cost, $description, $currency).'" target=_blank>'.$link_text.'</a>';
}
